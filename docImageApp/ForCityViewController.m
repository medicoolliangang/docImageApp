...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  NSString* urlString = [NSString stringWithFormat:@"http://accounts.i-md.com/hospital:areas?province=%@&city=%@&r=1352797562477",self.province,[cityDic objectAtIndex:row]]; //stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    area.httpRequest = [imdRequest getRequest:urlString delegate:area requestType:@"getHospital"];
